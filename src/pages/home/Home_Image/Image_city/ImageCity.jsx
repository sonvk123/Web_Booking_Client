  ...
  return (
    <>
      <div className={`${styles["items"]}`}>
        <img
          src={`http://localhost:5000/images/${hotels_city.HN.image}`}
          alt=""
      ...
      <div className={`${styles["items"]}`}>
        <img
          src={`http://localhost:5000/images/${hotels_city.HCM.image}`}
          alt=""
          className={`${styles["image"]}`}
        />
      ...
      <div className={`${styles["items"]}`}>
        <img
          src={`http://localhost:5000/images/${hotels_city.DN.image}`}
          alt=""
          className={`${styles["image"]}`}
        />
